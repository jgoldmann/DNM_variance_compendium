...
colSpec <- cols(SampleID = col_character(), 
                Chr = col_character())
mutations_c1 <- read_delim(here("data/mutations_c1.tsv"), delim = "\t", col_types = colSpec)
mutations_c2 <- read_delim(here("data/mutations_c2.tsv"), delim = "\t", col_types = colSpec)
mutations_c3 <- read_delim(here("data/mutations_c3.tsv"), delim = "\t", col_types = colSpec)
mutations_c4 <- read_delim(here("data/mutations_c4.tsv"), delim = "\t", col_types = colSpec)
